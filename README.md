...
- [Payment Runbook](./docs/payments/runbook.md) — optional testnet payment service deployment and checks
...
│   ├── payment-service/     # Optional x402 analysis and testnet escrow demo service
│   └── policy-worker/       # Policy evaluation worker (scaffold)
├── packages/
│   ├── config/              # Shared runtime configuration parsing
...
│   ├── contracts / economy  # Optional escrow contracts, deployment records, and economy adapter
...
│   ├── react / ui / presentation-bridge         # Shared UI and live presentation boundaries
...
├── examples/                 # Reference games including tic-tac-toe, blackjack, and neon-duel
...
NEXT_PUBLIC_ARCADE_PAYMENTS_URL=http://localhost:4021
...
| Optional payments          | Forge escrow contracts, `packages/economy`, x402 payment service                                            |
